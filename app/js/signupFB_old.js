...
var dataSend = {
 ...
 "credentials": { "id":uid, "access_token":token, "expires":parseInt(exp) },
 "profile":{"email":"nickvincent@ucla.edu", "first_name":firstName, "last_name":lastName,
...
document.addEventListener('deviceready', function() {
 try {
 FB.init({ appId: "644930635566311", nativeInterface: CDV.FB, useCachedDialogs: false });
 } catch (e) {
 alert(e);
 }
 }, false);